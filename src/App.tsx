...
export default function App() {
  ...
  const startBot = () => {
    fetch("https://api.daily.co/v1/bots/start", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${import.meta.env.VITE_DAILY_BOTS_API_KEY}`,
      },
      body: JSON.stringify({
        bot_profile: "revel",
        max_duration: 300,
  ...
  useAppMessage({
    onAppMessage: useCallback(
      (message: DailyEventObjectAppMessage<TranslationAppMessage>) => {
        console.log(message);
  ...
  return (
    <>
      <div className="App">
        0. Start the bot and create the room.
        <br />
        <button onClick={startBot}>Start Bot</button>
        <br />
        <br />
        1. Set the room URL. (Generated by step 0)
        <br />
        <input
          type="text"
          value={dailyRoomUrl}
